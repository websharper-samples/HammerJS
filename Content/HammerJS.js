...
{
 "use strict";
 var Global,Sample,Client,WebSharper,Obj,UI,HtmlModule,attr,Operators,EventTarget,Recognizer,Doc,AttrProxy,Elt,JavaScript,Pervasives,Client$1,Templates,DomUtility,Attrs,DocElemNode,Updates,View,Node,JS,Collections,Dictionary,Unchecked,Array,Attrs$1,Dyn,Snap,SC$1,Arrays,HashSet,Seq,WindowOrWorkerGlobalScope,SC$2,Docs,CharacterData,List,T,Object,DictionaryUtil,Prepare,Slice,Enumerator,KeyCollection,An,Settings,Abbrev,Mailbox,Fresh,SC$3,Strings,Docs$1,RunState,NodeSet,Anims,SC$4,T$1,SC$5,Concurrency,AppendList,HashSetUtil,SC$6,Easing,AsyncBody,SC$7,CT,HashSet$1,Scheduler,CancellationTokenSource,DomNodes,Queue,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,Hammer,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 Sample=Global.Sample=Global.Sample||{};
 ...
 {
  var d1,d2,hammer2,r,d3,hammer3,r$1,r$2,r$3,a;
  d1=Doc.Element("div",[AttrProxy.Create("style","background : silver; height : 150px; text-align: center; font: 15px/150px Helvetica, Arial, sans-serif;")],[]);
  (new Global.Hammer(d1.elt)).on("panleft panright tap press",function(ev)
  {
   var b;
   d1.Clear();
   b=Doc.Element("div",[],[Doc.TextNode(ev.type+"gesture detected")]);
   d1.elt.appendChild(b.elt);
  });
  d2=Doc.Element("div",[AttrProxy.Create("style","background : silver; height : 150px; text-align: center; font: 15px/150px Helvetica, Arial, sans-serif;")],[]);
  hammer2=new Hammer.Manager(d2.elt);
  hammer2.add(new Hammer.Swipe((r={},r.direction=Hammer.DIRECTION_ALL,r)));
  hammer2.on("swipeleft swiperight swipeup swipedown panleft panright tap press",function(ev)
  {
   var b;
   d2.Clear();
   b=Doc.Element("div",[],[Doc.TextNode(ev.type+"gesture detected")]);
   d2.elt.appendChild(b.elt);
  });
  d3=Doc.Element("div",[AttrProxy.Create("style","background : silver; height : 150px; text-align: center; font: 15px/150px Helvetica, Arial, sans-serif;")],[]);
  hammer3=new Hammer.Manager(d3.elt);
  hammer3.add(new Hammer.Tap((r$1={},r$1.event="doubletap",r$1.taps=2,r$1)));
  hammer3.add(new Hammer.Tap((r$2={},r$2.event="singletap",r$2)));
  hammer3.get("doubletap").recognizeWith("singletap");
  hammer3.get("singletap").requireFailure("doubletap");
  hammer3.add(new Hammer.Pan((r$3={},r$3.direction=Hammer.DIRECTION_ALL,r$3)));
  hammer3.on("singletap doubletap panleft panright press",function(ev)
  {
   var b;
   d3.Clear();
   b=Doc.Element("div",[],[Doc.TextNode(ev.type+"gesture detected")]);
   d3.elt.appendChild(b.elt);
  });
  a=Doc.Element("div",[],[Doc.Element("h2",[],[Doc.TextNode("Simple hammer class")]),d1,Doc.Element("h2",[],[Doc.TextNode("This one only detects swipe")]),d2,Doc.Element("h2",[],[Doc.TextNode("Doubletap will not trigger singletap")]),d3]);
